				...
				<c:forEach items="${movieBest}" var="movieBest">
					<li class="<c:out value='${movieBest.movieInfo_no}'/>">
						<div class="main-video-wrap"
							style="background-image:url('<c:out value='${movieBest.movieInfo_bkimg}'/>')">
							...
							<div class="best-info">
								<p>
									<c:out value='${movieBest.movieInfo_title}' />
								</p>
								<span> <c:out value='${movieBest.movieInfo_con}' />
								</span> <a href="/movie?MovieInfo_no=<c:out value='${movieBest.movieInfo_no}'/>" class="btn">보러가기 <i class="fa fa-chevron-right"></i></a>
							</div>
						</div>
					</li>
				</c:forEach>
							...
							<div class="list-con-title">
								...
								<p>
									...
									<span class="left-line-gray cateList">
										<c:out value="${movieBest.movieInfo_category}" />
									</span>
								</p>
							</div>
						</li>
